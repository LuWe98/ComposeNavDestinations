...
fun Resolver.isImportNameContainedInPackage(packageImport: PackageImport, importName: String) = isImportNameContainedInPackage(packageImport.root, importName)
