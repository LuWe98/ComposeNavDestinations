...
object NavArgsGeneratorUtilsNew {

    fun generateRoute(sortedParams: List<Parameter>): String {
        return ""
    }

    fun generateRouteOld(sortedParams: List<Parameter>): String {
    ...
    fun generateNamedNavArgumentsOld(sortedParams: List<Parameter>) = sortedParams.joinToString(",\n\t\t") { parameter ->
    ...
    fun generateInvokeParametersOld(component: NavComponentInfo) = component
        .navArgsInfo!!
        .parameters
        .joinToString(",\n\t\t", transform = Parameter::fullDeclarationName)

    fun generateInvokeBodyOld(routeName: String, sortedParams: List<Parameter>): String {
        var optionalNavSeparator = '?'
    ...
    fun generateGetArgsBodyOld(component: NavComponentInfo, argContainer: AndroidArgsContainer): String = component
        .navArgsInfo!!
        .parameters
        .joinToString(",\n\t\t") { parameter ->
